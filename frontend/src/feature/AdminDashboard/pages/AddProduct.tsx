      ...
      <div className="p-4">
        <Formik
          ...
          onSubmit={async (values, actions) => {
            ...
            const res = await ProductService.createProduct({ ...values, tags });
            ...
            <Form>
              ...
              <div className="flex gap-4">
                ...
                <Field name="quantity" validate={validateQuantity}>
                  {({ field, form }: any) => (
                    ...
                    >
                      <FormLabel className="mt-4">Available Quantity</FormLabel>
                      <NumberInput
                        {...field}
                        value={field.value}
                        onChange={(valueString) =>
                          form.setFieldValue(field.name, parseInt(valueString))
                        }
                        step={1}
                        defaultValue={0}
                        min={0}
              ...
              <Field name="discountPercentage" validate={validateDiscount}>
                {({ field, form }: any) => (
                  ...
                  >
                    <FormLabel className="mt-4">Discount Percentage</FormLabel>
                    <NumberInput
                      {...field}
                      value={field.value}
                      onChange={(valueString) =>
              ...
              <Field name="warrantyInformation" validate={validateName}>
                {({ field, form }: any) => (
                  ...
                  >
                    <FormLabel className="mt-4">Warranty Information</FormLabel>
                    <Textarea
                      {...field}
